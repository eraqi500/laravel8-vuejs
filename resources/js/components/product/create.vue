                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="product_code" placeholder="Enter Your Product Code" v-model="form.product_code">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="product_root"  v-model="form.root">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="product_price"  v-model="form.buying_price">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="product_selling_price" v-model="form.selling_price">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="product_buying_date" v-model="form.buying_date">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="product_Quantity" placeholder="Enter Your Quantity" v-model="form.product_quantity">
